      ...
      <Flex w="100%" direction="column" mb={4} px="3%" py="1%">
        ...
        <Flex gap={5} direction="column" align="center">
          <Image
            ...
            alt='Dan Abramov'
          />
          <Flex w="100%" direction="column" gap={3} py="2px" textAlign={{ base: "center", md: "left" }}>
            <Text fontSize="lg" color="teal">{company.name}</Text>
            <Text fontSize="xs" textColor="gray.500" as="i">{company.email}</Text>
            <Text fontSize="sm"><Icon color="teal" as={FaMapMarkerAlt}/> {`${company.city}, ${company.country}`}</Text>
            <Divider my={1} />
            <Text fontWeight="semibold" textColor="gray.600">Description</Text>
